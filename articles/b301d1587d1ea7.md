...
| ------------------ | ---------------- | -------------------------- | ------------ | ------------- |
| ボタンのレイアウト | 安定             | 意図しない変更を検知したい | 構造         | ✅ VRT 向き   |
| ボタンのラベル     | 頻繁             | 意図的な変更が多い         | データ       | ❌ VRT 不向き |
| アイコン位置       | 安定             | 意図しない変更を検知したい | 構造         | ✅ VRT 向き   |
...
| 対象                    | 基準 1: 変更頻度                                 | 基準 2: 変更の種類         | 基準 3: 性質 | 結論          |
| ----------------------- | ------------------------------------------------ | -------------------------- | ------------ | ------------- |
| テーブルのレイアウト    | 安定                                             | 意図しない変更を検知したい | 構造         | ✅ VRT 向き   |
| ステータス全種類        | 未知数                                           | 意図的な変更が多い         | データ       | ❌ VRT 不向き |
| アイコン付き/なしの構造 | 安定                                             | 意図しない変更を検知したい | 構造         | ✅ VRT 向き   |
| 長文/短文の高さ         | 安定（テキスト自体が持つスタイルは変わりにくい） | 意図しない変更を検知したい | 構造         | ✅ VRT 向き   |
